...
//    let oneMinuteVCIsRunning: Bool = NSUserDefaults.standardUserDefaults().boolForKey("OneMinuteVCIsRunning")

    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        // Override point for customization after application launch.
        
//        sleep(10) //no more than 10 and the watchdog will kill the thread if too long
...
//        }
    ...
    func touchIDAuth() {
        ...
        let navigationController = window!.rootViewController as! UINavigationController
        let sevenYearsVC = navigationController.topViewController as! SevenYearsTableViewController
        sevenYearsVC.viewWillAppear(false)
...
//        NSUserDefaults.standardUserDefaults().setBool(false, forKey: "OneMinuteVCIsRunning")
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.zwq.OneMinute" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("OneMinute", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("TiTa.sqlite")
